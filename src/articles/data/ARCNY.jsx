...
export default function ARCNY(){
    return(
        <div className="article">
            ...
            <img className="imageFit" src={getAssetUrl('articles/data/assets/CNY_gif2.gif')} alt="" />
            ...
            <img className="imageFit" src={getAssetUrl('articles/data/assets/CNY_playthrough.gif')} alt="" />
