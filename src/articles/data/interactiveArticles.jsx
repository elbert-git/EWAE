...
export default function InteractiveArticles(){
    return(
        <div className="article">
            <img className="imageFit" src={getAssetUrl('InteractiveArticles_Hero.png')} alt="" />
            ...
            <img className="imageFit" src={getAssetUrl('InteractiveArticles_Calipers.gif')} alt="" />
            ...
            <img className="imageFit" src={getAssetUrl('InteractiveArticles_QR.gif')} alt="" />
