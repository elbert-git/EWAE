...
export default function GenesisExperience(){
    return(
        <div className="article">
            ...
            <img className="imageFit" src={getAssetUrl('Genesis_Diagram.jpg')} alt="" />
            ...
            <img className="imageFit" src={getAssetUrl('Genesis_BoatAR.gif')} alt="" />
            <img className="imageFit" src={getAssetUrl('Genesis_Retail.gif')} alt="" />
        </div>
    )
}